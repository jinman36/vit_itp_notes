...
# 1. What does the openpyxl.load_workbook() function return? -> a workbook

# 2. What does the wb.sheetnames workbook attribute contain? -> list of list of sheetnames as strings
